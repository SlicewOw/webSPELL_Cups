...
onmouseout="hideWMTT()" />';
    ...
    if (iscupadmin($id)) {
        $cup = '<input id="switch-onColor" type="checkbox" data-on-color="success" data-off-color="danger" name="cupadmin" value="1" checked="checked" />';
    } else {
        $cup = '<input id="switch-onColor" type="checkbox" data-on-color="success" data-off-color="danger" name="cupadmin" value="1" />';
    }
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="row bt">
            <div class="col-md-6">' . $cup . '</div>
            <div class="col-md-6"><span class="pull-right text-muted small"><em>Cup Admin</em></span></div>
        </div>
