...
try {
    ...
    if (!$loggedin || !(getTicketAccess($ticket_id) || $cupAdminAcess)) {
    ...
    if (validate_array($_POST, true)) {
        ...
        $teamLink = ($cupAdminAcess && ($varPage == 'admin')) ?
            ...
            'index.php?site=teams&amp;action=details&amp;id=';
        ...
        $ticketSeenFlag = getTicketSeenDate($ticket_id, $userID, $cupAdminAcess);
        ...
        if ($temp_status) {
            ...
            if ($cupAdminAcess && ($varPage == 'admin')) {
        ...
        if ($temp_status2) {
            ...
            if ($cupAdminAcess) {
                ...
                $userLogLink = $admin_url . '/admincenter.php?site=cup&amp;mod=gameaccounts&amp;action=log&amp;user_id=';
                $teamDetailsLink = $admin_url . '/admincenter.php?site=cup&mod=teams&action=active&teamID=';
