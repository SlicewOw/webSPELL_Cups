...
try {
    ...
    $info .= '<span class="list-group-item">Check-In: ' . getformatdatetime($cupArray[getConstNameCheckIn()]) . '</span>';
    $info .= '<span class="list-group-item">Start: ' . getformatdatetime($cupArray[getConstNameStart()]) . '</span>';
